...
package com.phearom.um.utils;

import android.os.Bundle;
import android.support.v4.media.MediaMetadataCompat;
import android.support.v4.media.session.MediaSessionCompat;

import com.phearom.um.VoiceSearchParams;
...
import static com.phearom.um.utils.MediaIDHelper.MEDIA_ID_MUSICS_BY_SEARCH;
...
public class QueueHelper {
    ...
    public static List<MediaSessionCompat.QueueItem> getPlayingQueueFromSearch(String query,
            Bundle queryParams, MyMusicProvider musicProvider) {
     ...
     */
    public static List<MediaSessionCompat.QueueItem> getRandomQueue(MyMusicProvider musicProvider) {
