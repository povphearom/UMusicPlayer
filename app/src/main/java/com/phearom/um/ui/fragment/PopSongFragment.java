...
import com.phearom.um.databinding.FragmentPopSongBinding;
import com.phearom.um.model.MyMusicProvider;
import com.phearom.um.server.OnResultCallback;
import com.phearom.um.server.RequestGetPopSong;
import com.phearom.um.ui.MediaBrowserFragment;
...
public class PopSongFragment extends BaseFragment {
    ...
    public void onConnected() {
        RequestGetPopSong getPopSong = new RequestGetPopSong(getContext());
        getPopSong.setOnResultCallback(new OnResultCallback<List<MediaMetadataCompat>>() {
            @Override
