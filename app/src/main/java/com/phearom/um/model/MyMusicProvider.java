 ...
 */
public class MyMusicProvider {
    private static MyMusicProvider instance = new MyMusicProvider();

    private static final String TAG = LogHelper.makeLogTag(MyMusicProvider.class);
    ...
    public static MyMusicProvider init() {
        return instance;
    }
